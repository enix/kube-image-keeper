...
func main() {
	...
	var ignoreImageAbsentInRemoteRegistry bool
	...
	flag.BoolVar(&ignoreImageAbsentInRemoteRegistry, "ignore-image-absent-in-remote-registry", false, "Verify image presence in remote registry before rewriting pod's image repository")
	...
	imageRewriter := kuikenixiov1.ImageRewriter{
		...
		IgnoreImageAbsentInRemoteRegistry: ignoreImageAbsentInRemoteRegistry,
		ProxyPort:                         proxyPort,
		DescriptorFetcher:                 descriptorFetcher,
	}
