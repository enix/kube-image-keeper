...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		// The process ends as soon as the manager stops, so the lease is released on the way
		// out and a rollout does not wait LeaseDuration for the new pod to take over.
